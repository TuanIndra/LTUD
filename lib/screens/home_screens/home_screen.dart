                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: List.generate(3, (index) => Column(
                            children: [
                              featuredButton(icon: featureList1[index], title: featureTitles1[index]),
                              10.heightBox,
                              featuredButton(icon: featureList2[index], title: featureTitles2[index]),
                            ],
                          )
                        ).toList(),
                      ),
                              ...
                              children: List.generate(6,
                                      (index) => Column(
                                        ...
                                        children: [
                                          ...
                                          10.heightBox,
                                          "Laptop 16GB/1TB".text.fontFamily(semibold).color(darkFontGrey).make(),
                                          10.heightBox,
