...
import 'package:damh_flutter/screens/chat_screens/messaging_screen.dart';
import 'package:damh_flutter/screens/orders_screens/orders_screen.dart';
...
import 'package:damh_flutter/screens/wishlist_screens/wishlist_screen.dart';
...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (currentUser == null) {
      ...
      return const Center(
        child:
            CircularProgressIndicator(), // Hiển thị loader trong thời gian ngắn
      );
    }
    return bgWidget(
        child: Scaffold(
              ...
              ListView.separated(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return ListTile(
                          ...
                          title: profilesButtonList[index]
                              .text
                              .fontFamily(semibold)
                              .color(darkFontGrey)
                              .make(),
